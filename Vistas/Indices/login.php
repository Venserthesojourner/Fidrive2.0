...
<form action="#" method="post" onsubmit="generarHashPassword()">
    ...
    <div class="row">
        ...
        <div class="col-md-4" style="margin:25px">
            <div class="row">
                <label class="control-label" for="archivo"><strong>Contraseña</strong></label>
            </div>
            <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-4" style="margin:25px">
            ...
            <div class="row"> <button class="btn btn-info" type="submit" formmethod='post' formaction='../Acciones/accionLogin.php'>Enviar</button>
</form>
